...
// }
import { useState } from 'react';
import { Settings, Bell, Shield, Globe, Clock, Save } from 'lucide-react';
import { Button, Card, Toggle, Input, Select, Toast } from '../../components/UI';
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-0.5">Configure your Callyzer workspace</p>
        </div>
            ...
            {TABS.map(tab => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all ${activeTab === tab.key
            ...
            <>
              <Card>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Basic system configuration</p>
                  </div>
                </div>
              ...
              <Card>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-slate-800">Work Hours</h3>
                    <p className="text-xs text-slate-400">Define standard working hours</p>
                  </div>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                  <Input
                    ...
                    type="time"
                    value={general.workStart}
                    onChange={e => setGeneral(p => ({ ...p, workStart: e.target.value }))}
                  />
                  <Input
                    label="Work End Time"
                    type="time"
                    value={general.workEnd}
                    onChange={e => setGeneral(p => ({ ...p, workEnd: e.target.value }))}
                  />
                </div>
              </Card>
            </>
            ...
            <Card>
              ...
              <div className="divide-y divide-slate-50">
                <Toggle
                  ...
                  onChange={v => setNotifications(p => ({ ...p, emailOnNewUser: v }))}
                ...
                <Toggle
                  ...
                  onChange={v => setNotifications(p => ({ ...p, emailDailyDigest: v }))}
                  label="Daily Digest"
                  description="Get a daily overview of call activity"
                />
                <Toggle
            ...
            <Card>
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Protect your workspace</p>
                </div>
              </div>
              <div className="divide-y divide-slate-50 mb-5">
                ...
                <Toggle
                  ...
                  onChange={v => setSecurity(p => ({ ...p, forcePasswordChange: v }))}
