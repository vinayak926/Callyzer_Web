...
const MENUS = {
    ...
    business_user: [
        ...
        { path: '/business/salesperson-reports',    label: 'Salesperson Reports',   icon: BarChart2 },
...
const PAGE_TITLES = {
    ...
    '/business/salesperson-reports':   { title: 'Salesperson Reports',   subtitle: 'View call reports for each salesperson' }, 
